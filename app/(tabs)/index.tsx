      ...
      >
        <Text
          ...
          style={[
            styles.bubbleText,
            {
              color: isMe ? CHAT_BUBBLE_SELF_TEXT : "white",
              fontSize,
              lineHeight,
              maxWidth: innerMax,
...
const styles = StyleSheet.create({
  ...
  activeFriendsList: { flex: 1, backgroundColor: "transparent" },
  activeListContent: { paddingHorizontal: 0, backgroundColor: "transparent" },
  activeListHeader: {
    flexDirection: "row",
    alignItems: "baseline",
  ...
  activeListHeaderLabel: {
    color: MUTED2,
    fontSize: TYPE_CAPTION,
    fontFamily: fonts.medium,
    letterSpacing: 0.2,
  },
  activeListHeaderCount: {
    color: MUTED3,
    fontSize: TYPE_CAPTION,
    fontFamily: fonts.medium,
  },
  ...
  activeBody: { flex: 1, minHeight: 0, backgroundColor: "transparent", position: "relative" },
  synqHeaderSide: {
    width: 40,
    alignItems: "center",
    justifyContent: "center",
  ...
  myBubble: {
    backgroundColor: CHAT_BUBBLE_SELF,
    ...Platform.select({
      ios: {
        shadowColor: CHAT_BUBBLE_SELF,
